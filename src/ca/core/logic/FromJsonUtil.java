...
public class FromJsonUtil 
{
	...
	private static JSONObject jsonKey2Low(JSONObject input)
	{
		...
		{ 
			...
			sb.append(c);
			sb.append(key.subSequence(1, key.length() - 1));
			char c1 = key.charAt(key.length() - 2);
	...
	public static Object getDTO(String jsonString, Class clazz) {
		...
		try {
			...
			jsonObject = FromJsonUtil.jsonKey2Low(jsonObject);
		} catch (Exception e) {
			e.printStackTrace(); 	
		}
